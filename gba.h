...
#define TAN COLOR(27, 23, 16)
#define BURGANDY COLOR(19, 3, 3)
...
// JUST_PRESSED if not pressed in the last input (oldButtons) but is pressed in current input
// Uses the KEY_DOWN macro to check if the button was pressed in inputs.
